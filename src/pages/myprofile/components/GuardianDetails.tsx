...
export type GuardianDetailsHandle = {
...
const GuardianDetails = forwardRef<GuardianDetailsHandle, GuardianDetailsProps>(
  ({ onSaved }, ref) => {
    ...
    useEffect(() => {
      const sub = methods.watch((_v, { name }) => {
        ...
        const result = guardianDetailsSchema.safeParse({
          guardians: methods.getValues("guardians"),
        });
                  ...
                  <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-3">
                    <div>
                      <label className={labelClass}>
                        Guardian Type <span className="text-primary">*</span>
                      </label>
                      <Controller
                      ...
                      {guardianErrors?.guardianType && (
                        <p className={errorClass}>
                          {guardianErrors.guardianType.message as string}
                        </p>
                      )}
                    </div>
                    <div>
                      <label className={labelClass}>
                        {isFamily ? "Relation" : "Position"}{" "}
                      ...
                      {guardianErrors?.relation && (
                        <p className={errorClass}>
                          {guardianErrors.relation.message as string}
                        </p>
                      )}
                    </div><div>
                      <label className={labelClass}>
                      ...
                      {guardianErrors?.firstName && (
                        <p className={errorClass}>
                          {guardianErrors.firstName.message as string}
                        </p>
                      )}
                    </div>
                    <div>
                      ...
                      {guardianErrors?.lastName && (
                        <p className={errorClass}>
                          {guardianErrors.lastName.message as string}
                        </p>
                      )}
                    </div><div>
                      <label className={labelClass}>
                      ...
                      {guardianErrors?.mobileNumber && (
                        <p className={errorClass}>
                          {guardianErrors.mobileNumber.message as string}
                        </p>
                      )}
                    </div>
                    <div>
                      ...
                      {guardianErrors?.mobileNumber2 && (
                        <p className={errorClass}>
                          {guardianErrors.mobileNumber2.message as string}
                        </p>
                      )}
                    </div>
                  </div>
